...
public class BuildMap {
    ...
    public void FirstShip(Map<String, String> myMap1) {
        myMap1.put("A1", "HIT");
        myMap1.put("B1", "HIT");
    }
    public void SecondShip(Map<String, String> myMap1) {
        myMap1.put("H4", "HIT");
        myMap1.put("H5", "HIT");
        myMap1.put("H6", "HIT");
    }
    public void ThirdShip(Map<String, String> myMap1) {
        myMap1.put("J7", "HIT");
        myMap1.put("J8", "HIT");
        myMap1.put("J9", "HIT");
    }
    public void FourthShip(Map<String, String> myMap1) {
        myMap1.put("A10", "HIT");
        myMap1.put("B10", "HIT");
        myMap1.put("C10", "HIT");
        myMap1.put("D10", "HIT");
    ...
    public void FiftShip(Map<String, String> myMap1) {
        myMap1.put("E3", "HIT");
        myMap1.put("E4", "HIT");
        myMap1.put("E5", "HIT");
        myMap1.put("E6", "HIT");
    ...
    public void Builder() {
        ...
        while( i < 6){
            ...
            if (i == 1) { FirstShip(myMap1); }
            if (i == 2) { SecondShip(myMap1); }
            if (i == 2) { ThirdShip(myMap1); }
            if (i == 4) { FourthShip(myMap1); }
            if (i == 5) { FiftShip(myMap1); }
